...
func translateHTTPRouteToEnvoyRoutes(
	...
	allHCMFilterConfigs []HCMFilterConfig,
	...
	for ruleIndex, rule := range httpRoute.Spec.Rules {
		...
		if filterState.resolvedRefsErr != nil {
			resolvedRefsFailure = filterState.resolvedRefsErr
		}
	...
	if len(droppedRuleMessages) > 0 && len(envoyRoutes) == 0 {
		...
		notAccepted = &cond
		return nil, nil, nil, notAccepted, nil, nil
	}
	...
	return envoyRoutes, allHCMFilterConfigs, allValidBackendRefs, nil, resolvedRefsFailure, partiallyInvalid
}
